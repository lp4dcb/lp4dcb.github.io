$(function () {
    ...
    $(function () {
        ...
        $(nToggle).click(function () {
            $(nToggle).hasClass('is-active') ? $(nToggle).removeClass('is-active') : $(nToggle).addClass('is-active')
            if ($(nav).hasClass(no)) {
                ...
                let navH = $(nav).css('height', 'auto').height();
                $(nav).height(0).animate({ height: navH }, 300);
                setTimeout(function () {
